...
export const seedUsers = [
  {
    ...
    moduleKeys: ['dashboard', 'users', 'roles', 'audit', 'governance'],
    createdAt: '2026-04-26T18:00:00.000Z',
    updatedAt: '2026-04-26T18:00:00.000Z',
  ...
  },
  {
    ...
    moduleKeys: ['dashboard', 'governance', 'roles', 'audit', 'users'],
...
export const seedBaseGovernanceRoles = [
  {
    ...
    companyIds: ['cmp_demo', 'cmp_ops'],
    establishmentIds: ['est_demo_matrix', 'est_demo_branch', 'est_ops_matrix'],
    costCenterIds: [],
    status: 'active',
    version: 2,
    createdAt: '2026-04-26T18:00:00.000Z',
  ...
  },
  {
    ...
    companyIds: ['cmp_demo', 'cmp_ops'],
    establishmentIds: ['est_demo_matrix', 'est_ops_matrix'],
    costCenterIds: [],
    status: 'active',
    version: 1,
  ...
  {
    roleId: 'role_supervisor_ops',
    tenantId: 'tenant_ops',
    key: 'supervisor',
    name: 'Supervisor',
    description:
      'Acompanha empresas externas, papeis administrativos e trilhas de auditoria.',
    permissionKeys: [
      'users.read',
      'roles.read',
      'audit.read',
